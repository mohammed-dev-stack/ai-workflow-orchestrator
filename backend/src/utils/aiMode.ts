// ============================================================
// backend/src/utils/aiMode.ts
// ============================================================
// إدارة وضع الذكاء الاصطناعي (mock/real) مع دوال مساعدة
// ✅ تم إصلاح الوصول إلى model عبر anthropic.
// ============================================================
 ...
 * ✅ إصلاح: استخدام aiConfig.anthropic.model
 */
export const getAIModeStatus = (): {
  ...
  return {
    ...
    model: aiConfig.anthropic.model, // ✅ إصلاح
  };
};
