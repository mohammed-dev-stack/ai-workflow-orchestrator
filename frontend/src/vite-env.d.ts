...
// ✅ تم دمج env.d.ts و vite-env.d.ts في ملف واحد.
// ✅ يحتوي على جميع المتغيرات من كلا الملفين.
// ✅ يضمن سلامة النوع 100% لجميع متغيرات البيئة.
// ============================================================
...
interface ImportMetaEnv {
  // ============================================================
  // 1. متغيرات البيئة الأساسية (مطلوبة)
  // ============================================================
  ...
  // ============================================================
  // 2. متغيرات البيئة الاختيارية (لها قيم افتراضية)
  // ============================================================
  ...
  /**
   * ما إذا كان WebSocket مُفعَّلاً (Feature Toggle)
   * @default 'false'
   */
  readonly VITE_WS_ENABLED?: 'true' | 'false';

  // ============================================================
  // 3. متغيرات مدمجة من Vite (متوفرة تلقائياً)
  // ============================================================
...
// 6. تم دمج env.d.ts و vite-env.d.ts في ملف واحد لتجنب التضارب
// ============================================================